      ...
      >
        <div className="mx-auto flex w-full max-w-[1180px] items-start justify-between gap-4 px-5 pb-5 pt-5 sm:gap-6 sm:px-8 sm:pb-6">
          ...
          >
            ...
            <span
              aria-hidden="true"
              className="hidden font-hand text-[1.38rem] leading-[0.9] text-ink-soft sm:block"
            >
              flavius
              <br />
              studio
                ...
                return (
                  <li key={item.href} className="shrink-0">
                    <a
                      ...
                      className={[
                        "group relative inline-block pb-2 font-mono text-[1.2rem] no-underline lg:text-[1.32rem]",
          ...
          <div className="flex shrink-0 items-center gap-5 pt-1.5 sm:gap-6">
            ...
            */}
            <button
              ...
              aria-label="menu"
              className="group relative inline-block pb-2 font-mono text-[1.2rem] lowercase text-ink transition-colors duration-[180ms] hover:text-accent md:hidden"
            >
              {/*
