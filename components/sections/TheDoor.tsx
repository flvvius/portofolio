      ...
      <Container>
        ...
        <div className="mt-14 grid-12 gap-x-8 gap-y-16">
          ...
          <div className="col-span-12 lg:col-span-6">
            <Rise delay={60}>
              <div className="measure space-y-5 font-mono text-[1.26rem] leading-[1.8] text-ink">
                <p>
                  {beforeMark}
                  {afterMark !== "" && (
                ...
                {socials.map((social, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="absolute inset-x-0 bottom-[26%] text-center font-mono text-[1.06rem] lowercase">
                        {social.label}
                      </span>
                    </a>
                    ...
                    */}
                    {social.nudge && (
                      <span
                        aria-hidden="true"
                        className="pointer-events-none absolute right-0 top-1/2 hidden -translate-y-1/2 translate-x-[calc(100%+16px)] font-hand text-3xl leading-none text-accent sm:inline-block sm:text-4xl"
                      >
                        {social.nudge}
                      </span>
                    )}
