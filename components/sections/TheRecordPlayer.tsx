        ...
        {tab.items.map((item, index) => (
          ...
          >
            <div className="flex items-baseline justify-between gap-4">
              <h4 className="font-mono text-[1.05rem] leading-snug text-ink">
                {item.line}
              </h4>
              <span className="shrink-0 font-mono text-[0.72rem] uppercase tracking-[0.12em] text-ink-soft">
                {item.date}
              </span>
            </div>
            ...
            <p className="measure mt-3 font-mono text-[0.95rem] leading-[1.75] text-ink-soft">
              {item.story}
            </p>
          </li>
        ))}
