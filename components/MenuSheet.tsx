...
export function MenuSheet({
  ...
  return (
    ...
    >
      ...
      >
        <p className="font-hand text-[1.35rem] leading-none text-ink-soft">
          what&apos;s where
        </p>
            ...
            return (
              <li key={item.href}>
                ...
                >
                  ...
                  <span
                    aria-hidden="true"
                    className="shrink-0 font-mono text-[0.75rem] text-ink-soft"
                  >
                    0{index + 1}
                  </span>
        ...
        <div className="mt-auto pt-12">
          <p className="font-mono text-[0.75rem] lowercase text-ink-soft">
            or find me at
          </p>
